...
# Splits a word, creatin a row for each (letter+its context)
...
articulatoryFeatures <- read.table(file="/home/jeremias/Desktop/netTalk/articulatoryFeatures/phonems_notitle.csv", header=FALSE, sep=",")
...
## PLAN: Create datasets with (250-1000-2000-5000-10000) words in training and the rest in test
## we will begin with only 1000


trainIdx <- sample(1:(dim(rawDataset)[1]),1000)
...
write.table(trainEncoded, file = "/home/jeremias/Desktop/netTalk/encodedDatasets/1000/nettalk.data", row.names = FALSE, col.names = FALSE)
write.table(testEncoded, file = "/home/jeremias/Desktop/netTalk/encodedDatasets/1000/nettalk.test", row.names = FALSE, col.names = FALSE)
write.table(trainIdx, file = "/home/jeremias/Desktop/netTalk/encodedDatasets/1000/trainIdx", row.names = FALSE, col.names = FALSE)
